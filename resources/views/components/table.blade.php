  ...
  <div class="mt-4 mx-4">
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  ...
                  <div>
                    <p class="font-semibold">Broken Door</p>
                    <p class="text-xs text-gray-600 dark:text-gray-400">Tchaka 21</p>
                  </div>
                </div>
              </td>
              <td class="px-4 py-3 text-sm">Doors</td>
              ...
              <td class="px-4 py-3 text-sm">15-02-2021</td>
            </tr>
            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  ...
                  <div>
                    <p class="font-semibold">Broken window</p>
                    <p class="text-xs text-gray-600 dark:text-gray-400">Tchaka Showers</p>
                  </div>
                </div>
              </td>
              <td class="px-4 py-3 text-sm">Windows</td>
              <td class="px-4 py-3 text-xs">
            ...
            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  ...
                  <div>
                    <p class="font-semibold">Power Failure</p>
                    <p class="text-xs text-gray-600 dark:text-gray-400">Tchaka 21</p>
                  </div>
                </div>
              </td>
              ...
              <td class="px-4 py-3 text-xs">
                <span class="px-2 py-1 font-semibold leading-tight text-gray-700 bg-gray-100 rounded-full dark:text-gray-100 dark:bg-gray-700"> Sorted </span>
              </td>
            ...
            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  ...
                  <div>
                    <p class="font-semibold">Broken Bed</p>
                    <p class="text-xs text-gray-600 dark:text-gray-400">Tchaka 23</p>
                  </div>
                </div>
              </td>
              <td class="px-4 py-3 text-sm">Rooms</td>
              <td class="px-4 py-3 text-xs">
                <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"> fixed </span>
              </td>
            ...
            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  ...
                  <div>
                    <p class="font-semibold">Power Socket Failure</p>
                    <p class="text-xs text-gray-600 dark:text-gray-400">Tchaka 21</p>
                  </div>
                </div>
              </td>
              <td class="px-4 py-3 text-sm">Power</td>
              <td class="px-4 py-3 text-xs">
                <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700"> Reserved </span>
              </td>
      ...
      <div class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
        <span class="flex items-center col-span-3"> Continue</span>
