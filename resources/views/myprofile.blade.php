<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="py-5 text-center">
            <a href="#" class="block text-2xl font-bold text-gray-800 dark:text-white">{{Auth::user()->name}}</a>
        ...
        <div class="container px-6 py-8 mx-auto">
            <div class="items-center lg:flex">
                <div class="lg:w-1/2">
                    <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100">Profile Details</h2>

                    <p class="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
                        Name : {{Auth::user()->name}}<br>
                        Email Address: {{Auth::user()->email}}<br>
                        Position: {{Auth::user()->role_id}}
                    </p>
                ...
                <div class="mt-8 lg:mt-0 lg:w-1/2">
                    ...
                    You're email address is: {{Auth::user()->email}}<br> --}}
                </div>
            </div>
        </div>
    </div>
