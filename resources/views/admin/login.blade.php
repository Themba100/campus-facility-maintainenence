 ...
 <body>
	   ...
	   <section class="min-h-screen flex items-stretch text-white ">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #333;">
            ...
            <div class="w-full py-6 z-20">
                ...
                <h1 class="my-6 font-bold uppercase flex justify-center text-2xl">
 							<!-- <img src="{{url('/images/UnimaLogo.png')}}" class ="flex justify-center"  />  -->
                ...
                <form action="{{route('loginadmin')}}" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                       
                        @if(Session::get('Authentication Failed'))
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
             <strong class="font-bold">
                                {{Session::get('Authentication Failed')}}</strong>
  <!-- <span class="block sm:inline">Something</span> -->
  <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
    <svg class="fill-current h-6 w-6 text-red-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Close</title><path d="M14.348 14.849a1.2 1.2 0 0 1-1.697 0L10 11.819l-2.651 3.029a1.2 1.2 0 1 1-1.697-1.697l2.758-3.15-2.759-3.152a1.2 1.2 0 1 1 1.697-1.697L10 8.183l2.651-3.031a1.2 1.2 0 1 1 1.697 1.697l-2.758 3.152 2.758 3.15a1.2 1.2 0 0 1 0 1.698z"/></svg>
                    ...
                    <div class="pb-2 pt-4">
                        <input class="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password" id="password" placeholder="Password" required value="{{old('password')}}">
                   <span class="alert alert-danger">
                                @error('email')
                                        {{$message}}
                                @enderror
                    ...
                    <div class="text-right text-gray-400 hover:underline hover:text-white">
                    ...
                    <div class="px-4 pb-2 pt-4">
                        <input class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none"  type="submit" value="Sign in">
                    </div>
