 ...
 <body>
	   ...
	   <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url('/images/gh.jpg');">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #333;">
			...
			<img src="{{url('/images/UnimaLogo.png')}}" className ="w-18  justify-center h-12"  /> 
                <h1 class="my-6 font-bold uppercase text-3xl">
 						Admin Portal
