 ...
 <body>
	   ...
	   <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url('/images/bg2.jpg');">
            <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            <div class="w-full px-24 z-10">
                <h1 class="text-2xl flex justify-center	 uppercase font-bold text-left tracking-wide">Campus Facility Maintainence</h1>
                <p class="text-1xl flex justify-center my-4">Welcome to the administration portal</p>
            </div>
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #333;">
            <div class="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);">
                <div class="absolute bg-blue-500 opacity-60 inset-0 z-0"></div>
            </div>
			
            <div class="w-full py-6 z-20">
			
                <h1 class="my-6 font-bold uppercase flex justify-center text-3xl">
 							<img src="{{url('/images/UnimaLogo.png')}}" class ="flex justify-center"  /> 
 						<!-- Admin Portal -->
...
<h1 class="my-6 font-bold uppercase flex justify-center text-3xl">
                ...
                <div class="bg-green-700 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
  <div class="flex">
    <div class="py-1"><svg class="fill-current h-6 w-50 text-teal-500 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM9 11V9h2v6H9v-4zm0-6h2v2H9V5z"/></svg></div>
    <div>
     	{{Session::get('success')}}
    </div>
  </div>
                ...
                <form action="{{route('admin.save')}}" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
				  	@csrf

				  <div class="pb-2 pt-4">
                        <input type="text" name="name" id="name" placeholder="name" class="block w-full p-4 text-lg rounded-sm bg-black" required value="{{old('name')}}">
                    ...
                    <div class="pb-2 pt-4">
                        <input type="email" name="email" id="email" placeholder="Email" class="block w-full p-4 text-lg rounded-sm bg-black" required value="{{old('email')}}">
                 ...
                 <span class="text-danger">@error('password')
					 ...
					 <div class="pb-2 pt-4">
                        <input class="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password_confirmation" id="password" placeholder="Confirm Password" requi>
                    </div>
