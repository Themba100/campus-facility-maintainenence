<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="bg-white w-full">
                         ...
                         <div class="flex-1 lg-items-center max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
  ...
  <img class=" h-auto w-full mx-auto" src="{{url('/images/defaultimage.png')}}" alt="">
            <div class="flex items-center px-6 py-3 bg-gray-900">
                ...
                <h1 class="mx-3 text-lg font-semibold text-white">Profile Description</h1>
            </div>

            <div class="px-6 py-4">
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{{Auth::user()->name}}</h1>

                <p class="py-2 text-gray-700 dark:text-gray-400">Member Of Staff. Unniversity of Malawi, Chancellor College</p>
                ...
                <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                    ...
                    <h1 class="px-2 text-sm"> University Of Malawi, Chancellor College</h1>
                </div>
                ...
                <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                    ...
                    <h1 class="px-2 text-sm">Zomba</h1>
                </div>
    ...
    <section class="bg-white dark:bg-gray-800">
        <div class="container px-6 py-8 mx-auto">
            <div class="items-center lg:flex">
                <div class="lg:w-1/2">
                    <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100">About {{Auth::user()->name}}</h2>

                    <p class="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
                        Hi I am {{Auth::user()->name}} , member of staff of the University of Malawi, Chancellor College <a class="font-bold text-indigo-600 dark:text-indigo-400" href="#">
